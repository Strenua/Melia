...
import gtk
import logging
logger = logging.getLogger('melia_lib')
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseMeliaWindow object.
        """
    ...
    def finish_initializing(self, builder):
        ...
        and creating a MeliaWindow object with it in order to finish
        initializing the start of the new MeliaWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('melia')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for melia."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for melia."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the MeliaWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the MeliaWindow is closed."""
