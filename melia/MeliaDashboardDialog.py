...
class MeliaDashboardDialog(gtk.Window):
	...
	def drag_motion(widget, drag_context, x, y, timestamp):
	    print x, y
	    self.move(x, y)
    ...
    def init_bottom_toolbar(self):
		...
		self.ui.bottom_toolbar.append_widget(button, 'About Melia', 'AboutMelia')
		self.ui.bottom_toolbar.show_all()
		self.parent.widgefy(self.ui.bottom_toolbar)
