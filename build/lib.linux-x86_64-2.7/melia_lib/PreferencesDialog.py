...
class PreferencesDialog(gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesMeliaDialog')
        new_object = builder.get_object("preferences_melia_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesMeliaDialog
        instance.
